...
{
    pressio library;  
    pressio_data metadata = pressio_data::empty(pressio_float_dtype, {500,500,100});    // size and type of data
    pressio_io posix = library.get_io("posix");
    posix->set_options({{"io:path",  "CLOUDf48.bin.f32"}}); // path to data file
